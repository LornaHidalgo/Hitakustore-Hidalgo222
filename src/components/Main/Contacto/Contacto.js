      ...
      <section className="contacto container main">
        <Container>
          <div className="contacto__texto">
            ...
            <p>
              Hablemos por{" "}
              <a href="https://www.instagram.com/hitakustore/">Instagram</a> 
              .
            </p>
          </div>
        </Container>
      ...
      <section className="redes">
        <div className="redes__div">
          ...
          <div className="redes__div--instagram">
            <a href="https://www.instagram.com/hitakustore/" target="_blanck">
              <i className="fab fa-instagram-square fa-5x"></i>
            </a>
            <a
              href="https://www.instagram.com/hitakustore/"
              target="_blanck"
